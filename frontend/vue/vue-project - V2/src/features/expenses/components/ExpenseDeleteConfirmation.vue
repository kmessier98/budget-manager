...
<template>
    <div>
        <Dialog header="Supprimer la dépense" :visible="true" modal @update:visible="emit('close')"
            class="delete-expense-dialog" :style="{ width: '600px', 'max-width': '90%' }">
            <div class="content">
                <div class="header">
            ...
            <div class="actions">
                <Button class="delete-button" label="Supprimer" @click="emit('deleted')"></Button>
                <Button class="cancel-button" label="Annuler" @click="emit('close')"></Button>
            </div>
        </Dialog>
    </div>
</template>
